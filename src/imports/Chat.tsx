import svgPaths from "./svg-o74seeiox7";
...
function BtnSend() {
  return (
    <div className="absolute h-[47.709px] left-[650.8px] top-[7.32px] w-[47.57px]" data-name="btn.Send">
...
function MessageExample() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="messageExample1">
      <ChatItem />
    </div>
  );
}
...
function MessageExample1() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-full" data-name="messageExample2">
      <ChatItem1 />
    </div>
  );
}
...
function MessageExample2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="messageExample3">
      <ChatItem2 />
    </div>
  );
}
...
function MessageExample3() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0 w-full" data-name="messageExample4">
      <ChatItem3 />
    </div>
  );
}
...
function ChatBox() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[25px] h-[751px] items-start left-[32px] overflow-clip top-[69px] w-[675px]" data-name="ChatBox">
      <MessageExample />
      <MessageExample1 />
      <MessageExample2 />
      <MessageExample3 />
...
export default function Chat() {
  return (
    <div className="bg-white relative size-full" data-name="chat">
      <div className="absolute h-[1080px] left-0 top-0 w-[1920px]" data-name="bg" style={{ backgroundImage: "linear-gradient(130.219deg, rgb(239, 243, 250) 0%, rgb(235, 240, 249) 44.749%, rgb(239, 243, 250) 91.253%)" }} />
      <Frame />
    </div>
  );
}